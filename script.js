document.addEventListener('DOMContentLoaded', () => {
    ...
    // Modificarea cheie: Eliminarea codului de server-side
    quizForm.addEventListener('submit', (event) => {
        ...
        if (selectedOption) {
            quizResult.textContent = "IARTA-MA, esti o prietena/asociata/concubina EXTRAORDINARA si mi-e tare dor de tine"; 
